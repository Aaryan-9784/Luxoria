...
export default function ContactMap() {
  return (
    <section className="w-full bg-black overflow-hidden flex justify-center">
      ...
      {/* Outer container to constrain height and crop top/bottom */}
      <div className="relative w-full h-[55vh] min-h-[450px] max-h-[600px] overflow-hidden group">
        
        {/* Inner fixed aspect ratio container matching the map image approx (16:9) 
            This is centered vertically. It ensures the map and the markers ALWAYS scale together flawlessly. */}
        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full aspect-[16/9]">
        ...
        {/* Overlay Gradient at bottom and top applied to the OUTER container to fade the cropped edges */}
        <div className="absolute bottom-0 left-0 w-full h-[80px] bg-gradient-to-t from-background to-transparent z-10 pointer-events-none" />
        <div className="absolute top-0 left-0 w-full h-[80px] bg-gradient-to-b from-surface to-transparent z-10 pointer-events-none" />
      </div>
